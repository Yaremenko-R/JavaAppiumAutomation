...
public class MainPageObject {
  ...
  public WebElement waitForElementPresent(String locator) {
    return waitForElementPresent(locator, "Cannot find element", 10);
  }
  ...
  public void assertSearchResultsCorrectness(String locator, String expected_text, String error_message) {
    List<WebElement> elements = waitForElementsPresent(locator);
  ...
  public String noWaitForElementAndGetAttribute(String locator, String attribute, String error_message) {
